...
class FinanceBertForTokenClassification(M):
    """Token classifier model based on BERT for finance tasks.

    FinanceBertForTokenClassifier can load Bert Models with a token
    ...
    >>> embeddings = FinanceBertForTokenClassification.pretrained() \\
    ...
    ...     .setOutputCol("token")
    >>> tokenClassifier = FinanceBertForTokenClassifier.pretrained() \\
    ...     .setInputCols(["token", "document"]) \\
    ...     .setOutputCol("label") \\
    ...
    +------------------------------------------------------------------------------------+
    """
    name = "FinanceBertForTokenClassification"

    @keyword_only
    def __init__(self, classname="com.johnsnowlabs.finance.token_classification.ner.FinanceBertForTokenClassification",
                 java_model=None):
        super(FinanceBertForTokenClassification, self).__init__(
            classname=classname,
    ...
    def loadSavedModel(folder, spark_session):
        ...
        FinanceBertForTokenClassification
            The restored model
        """
        from sparknlp_jsl.internal import _FinanceBertTokenClassificationLoader
        jModel = _FinanceBertTokenClassificationLoader(folder, spark_session._jsparkSession)._java_obj
        return FinanceBertForTokenClassification(java_model=jModel)
    ...
    def loadSavedModelOpenSource(bertForTokenClassifierPath, tfModelPath, spark_session):
        ...
        FinanceBertForTokenClassification
            The restored model
        """
        from sparknlp_jsl.internal import _FinanceBertTokenClassificationLoaderOpensource
        jModel = _FinanceBertTokenClassificationLoaderOpensource(bertForTokenClassifierPath, tfModelPath,
                                                             spark_session._jsparkSession)._java_obj
        return FinanceBertForTokenClassification(java_model=jModel)

    @staticmethod
    def pretrained(name="finner_responsibility_reports", lang="en", remote_loc="finance/models"):
        """Download a pre-trained FinanceBertForTokenClassification.

        Parameters
        ----------
        name : str
            Name of the pre-trained model, by default "finner_responsibility_reports"
        lang : str
        ...
        -------
        FinanceBertForTokenClassification
            A pre-trained FinanceBertForTokenClassification.
        """
        from sparknlp_jsl.pretrained import InternalResourceDownloader
        return InternalResourceDownloader.downloadModel(FinanceBertForTokenClassification, name, lang, remote_loc,
