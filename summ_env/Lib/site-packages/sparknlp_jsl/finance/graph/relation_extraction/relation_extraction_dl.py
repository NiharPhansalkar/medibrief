...
class _RelationExtractionDLModelLoader(ExtendedJavaWrapper):
    def __init__(self, path, jspark):
        super(_RelationExtractionDLModelLoader, self).__init__(
            "com.johnsnowlabs.finance.graph.relation_extraction.RelationExtractionDLModel.loadSavedModel", path, jspark)
...
class RelationExtractionDLModel(M):
    ...
    def __init__(self, classname="com.johnsnowlabs.finance.graph.relation_extraction.RelationExtractionDLModel",
                 java_model=None):
    ...
    @staticmethod
    def pretrained(name="finre_financial_small", lang="en", remote_loc="finance/models"):
        """Download a pre-trained RelationExtractionDLModel.

        Parameters
        ----------
            name : str
                Name of the pre-trained model, by default "finre_financial_small"
            lang : str
                Language of the pre-trained model, by default "en"
            remote_loc : str
                Remote location of the pre-trained model. If None, use the open-source location. Other values are "clinical/models", "finance/models", or "legal/models".
