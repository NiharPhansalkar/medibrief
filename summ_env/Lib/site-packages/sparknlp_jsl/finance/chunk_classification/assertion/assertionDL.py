...
from sparknlp_jsl.common import AnnotatorApproachInternal
...
class AssertionDLApproach(A):
    ...
    def __init__(self):
        AnnotatorApproachInternal.__init__(self,
            classname="com.johnsnowlabs.finance.chunk_classification.assertion.AssertionDLApproach")
...
class AssertionDLModel(M):
    """Deep Learning based approach used to extract Assertion Status from extracted entities and text. 
    ...
    def __init__(self, classname="com.johnsnowlabs.finance.chunk_classification.assertion.AssertionDLModel", java_model=None):
    ...
    @staticmethod
    def pretrained(name="finassertiondl_time_md", lang="en", remote_loc="finance/models"):
        """Download a pre-trained AssertionDLModel.

        Parameters
        ----------
            name : str
                Name of the pre-trained model, by default "finassertiondl_time_md"
            lang : str
