...
class DeIdentification(A):
    ...
    sameLengthFormattedEntities
        ...
        The supported and default formatted entities are: PHONE, FAX, ID, IDNUM, BIOID, ZIP, VIN, SSN, DLN, LICENSE, PLATE, CFN, IRS
    maskingPolicy
...
class DeIdentificationModel(M):
    ...
    These can be set with a file of regex patterns with setRegexPatternsDictionary, where each line is a 
    mapping of entity to regex.
    ...
    @staticmethod
    def pretrained(name="finner_deid", lang="en", remote_loc="finance/models"):
        """Download a pre-trained DeIdentificationModel.

        Parameters
        ----------
        name : str
            Name of the pre-trained model, by default "finner_deid"
        lang : str
