...
class FinanceBertForSequenceClassification(M):
    ...
    def loadSavedModel(folder, spark_session):
        ...
        FinanceBertForSequenceClassification
            The restored model
        """
        from sparknlp_jsl.internal import _FinanceBertForSequenceClassificationLoader
        jModel = _FinanceBertForSequenceClassificationLoader(folder, spark_session._jsparkSession)._java_obj
    ...
    def loadSavedModelOpenSource(bertForTokenClassifierPath, tfModelPath, spark_session):
        ...
        FinanceBertForSequenceClassification
            The restored model
        """
        from sparknlp_jsl.internal import _FinanceBertForSequenceClassificationLoaderOpensource
        jModel = _FinanceBertForSequenceClassificationLoaderOpensource(bertForTokenClassifierPath, tfModelPath,
                                                                       spark_session._jsparkSession)._java_obj
        return FinanceBertForSequenceClassification(java_model=jModel)

    @staticmethod
    def pretrained(name="finclf_bert_banking77", lang="en", remote_loc="finance/models"):
        """Download a pre-trained FinanceBertForSequenceClassification.

        Args:
            name (str): Name of the pre-trained model, by default "finclf_bert_banking77"
        ...
        Returns:
            FinanceBertForSequenceClassification: A pre-trained FinanceBertForSequenceClassification.
        """
