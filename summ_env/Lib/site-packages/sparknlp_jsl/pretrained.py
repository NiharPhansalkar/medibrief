...
class InternalResourceDownloader(object):
    ...
    @staticmethod
    def downloadModelDirectly(name, remote_loc="clinical/models", unzip=True, cache_folder_path=""):
        ...
        """
        _internal._DownloadModelDirectly(name, remote_loc, unzip, cache_folder_path).apply()
