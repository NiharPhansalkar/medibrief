...
class EntityRulerInternalApproach(AnnotatorApproachInternal, HasStorage):
    ...
    @keyword_only
    def __init__(self):
        super(EntityRulerInternalApproach, self).__init__(
            classname="com.johnsnowlabs.nlp.annotators.er.EntityRulerInternalApproach")
    ...
    def _create_model(self, java_model):
        return EntityRulerInternalModel(java_model=java_model)


class EntityRulerInternalModel(AnnotatorModelInternal, HasStorageModel):
    ...
    def __init__(self, classname="com.johnsnowlabs.nlp.annotators.er.EntityRulerInternalModel", java_model=None):
        super(EntityRulerInternalModel, self).__init__(
            classname=classname,
    ...
    def pretrained(name, lang="en", remote_loc=None):
        ...
        return InternalResourceDownloader.downloadModel(EntityRulerInternalModel, name, lang, remote_loc,
                                                        j_dwn='InternalsPythonResourceDownloader')

    @staticmethod
    def loadStorage(path, spark, storage_ref):
        HasStorageModel.loadStorages(path, spark, storage_ref, EntityRulerInternalModel.database)
