...
class ZeroShotRelationExtractionModel(MedicalBertForSequenceClassification, HasEngine):
    """
    ...
    negativeRelationships = Param(Params._dummy(),
                                  "negativeRelationships",
                                  " List of relational categories which server as negative examples",
    ...
    def setRelationalCategories(self, categories):
        ...
        self._call_java("setRelationalCategories", categories)
        return self

    def setNegativeRelationships(self, relations: list):
        """Set the list of relational categories which serve as negative examples and are not included in the output
        annotations
        ...
        """
        return self._set(negativeRelationships=relations)

    @keyword_only
    def __init__(self, classname="com.johnsnowlabs.nlp.annotators.re.ZeroShotRelationExtractionModel", java_model=None):
    ...
    @staticmethod
    def pretrained(name="zero_shot_re", lang="en", remote_loc="clinical/models"):
        ...
        Returns:
            ZeroShotRelationExtractionModel: A pre-trained ZeroShotRelationExtractionModel.
        """
    ...
    def loadSavedModel(folder, spark_session):
        ...
        ZeroShotRelationExtractionModel
            The restored model
        """
        from sparknlp_jsl.internal import _ZeroShotRelationExtractionModelLoader
        jModel = _ZeroShotRelationExtractionModelLoader(folder, spark_session._jsparkSession)._java_obj
