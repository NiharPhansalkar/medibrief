...
class ChunkFiltererApproach(AnnotatorApproachInternal, FilteringParams,HandleExceptionParams):
...
class ChunkFilterer(AnnotatorModelInternal, FilteringParams,HandleExceptionParams):
