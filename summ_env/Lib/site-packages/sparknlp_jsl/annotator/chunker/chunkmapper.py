...
class ChunkMapperFuzzyMatchingParams:
    """Contains shared parameters of FuzzyMatching annotators.
    """
    ...
    def setEnableTokenFingerprintMatching(self, etfm:bool):
        """Whether to apply partial token Ngram fingerprint matching.
        
        This will create matching keys with partial Ngrams driven by three params: 
        - minTokenNgramFingerprint
        - maxTokenNgramFingerprint
        - maxTokenNgramDropping
    ...
    def setEnableFuzzyMatching(self, efm:bool):
        """Whether to apply fuzzy matching.
    ...
    def setMaxTokenNgramFingerprint(self, mxtnf:int):
    ...
    def setMinTokenNgramFingerprint(self, mntnf:int):
    ...
    def setMaxTokenNgramDroppingTokens(self, etd:int):
        """Maximum number of tokens allowed to be dropped from the full chunk.

        The parameter enableTokenNgramMatching must be set to true.
        Whenever it is desired for all Ngrams to be used as keys, no matter how short the final
        chunk may be, this parameter should be set to a very high value: e.g., `sys.maxsize`.
    ...
    def setMaxTokenNgramDroppingCharsRatio(self, etd:float):
        """Maximum amount of tokens to allow dropping based on the maximum ratio of chars allowed to be dropped from the full chunk.

        The parameter enableTokenNgramMatching must be set to true.
        Whenever it is desired for all Ngrams to be used as keys, no matter how short the
        final chunk is, this param should be set to 1.0.
    ...
    def setMaxTokenNgramDroppingOperator(self, etd:float):
        """Maximum amount of tokens to allow dropping based on the maximum ratio of chars allowed to be dropped from the full chunk.

        The parameter enableTokenNgramMatching must be set to true.
        Whenever it is desired for all Ngrams to be used as keys, no matter how short, this
        param should be set to `1.0`.
    ...
    def setMaxCharNgramFingerprint(self, etfm:int):
    ...
    def setMinCharNgramFingerprint(self, etfm:int):
    ...
    def setFuzzyMatchingDistances(self, fmd:str):
    ...
    fuzzyMatchingDistanceThresholds = Param(Params._dummy(),
                                            ...
                                            "When enableFuzzyMatching is true, the Thresholds for fuzzy matching.",
...
class CommonChunkMapperParams(HandleExceptionParams):
    """CommonChunkMapperParams"""
    allowMultiTokenChunk = Param(Params._dummy(),
                                 "allowMultiTokenChunk",
                                 "Whether skip relations with multitokens",
                                 typeConverter=TypeConverters.toBoolean)
    ...
    def setRel(self, r):
        ...
        """
        warnings.warn("Use 'setRels' method instead of 'setRel' method", DeprecationWarning)
        self.setRels([r])
        return self
    ...
    lowerCase = Param(Params._dummy(),
                      "lowerCase",
                      "Whether to save the dictionary in lower case or not",
                      typeConverter=TypeConverters.toBoolean)
...
class ChunkMapperModel(AnnotatorModelInternal, CommonChunkMapperParams, ChunkMapperFuzzyMatchingParams):
    """Maps chunks to a dictionary of relations.
    ...
    @staticmethod
    def pretrained(name="drug_action_treatment_mapper", lang="en", remote_loc="clinical/models"):
        """Download a pre-trained ChunkMapperModel.

        Parameters
        ----------
            name : str
                Name of the pre-trained model, by default "drug_action_treatment_mapper"
            lang : str
        ...
        -------
            ChunkMapperModel
                A pre-trained ChunkMapperModel.
        """
