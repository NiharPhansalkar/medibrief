...
class CommonNerConverterInternalParams(FilteringParams):
   ...
   * This comes with a performance penalty.""",TypeConverters.toBoolean)
    ...
    def setAllowList(self, entities:list):
    ...
    def setDoExceptionHandling(self, value: bool):
        ...
        * This comes with a performance penalty.
        ...
        ----------
        value : bool
            True or False to handle exceptions.
        """
        return self._set(doExceptionHandling=value)


class NerConverterInternal(AnnotatorApproach, CommonNerConverterInternalParams, SourceTrackingMetadataParams):
    ...
    adding the following parameters: `blackList`, `greedyMode`,
    `threshold`, and `ignoreStopWords` that are not available in the
    `NerConverter` annotator.
    ...
    def setReplaceDictResource(self, path:str, read_as:str=ReadAs.TEXT, options:dict=None):
    ...
    def setReplaceLabels(self, labels:dict):
