...
class ZeroShotNerModel(RoBertaForQuestionAnswering, HasEngine):
    ...
    def setEntityDefinitions(self, definitions: dict):
    ...
    @keyword_only
    def __init__(self, classname="com.johnsnowlabs.nlp.annotators.ner.ZeroShotNerModel", java_model=None):
    ...
    @staticmethod
    def pretrained(name="zero_shot_ner_roberta", lang="en", remote_loc="clinical/models"):
        """Download a pre-trained ZeroShotNerModel.

        Parameters
        ----------
        name :str
            Name of the pre-trained model, by default "zero_shot_ner_roberta"
        lang :str
    ...
    def load(path: str):
        ...
        -------
            ZeroShotNerModel
                A pre-trained ZeroShotNerModel.
        """
        from sparknlp_jsl.internal import _RobertaQAToZeroShotNerLoader
