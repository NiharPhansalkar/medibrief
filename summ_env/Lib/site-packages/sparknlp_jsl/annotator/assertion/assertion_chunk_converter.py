...
class AssertionChunkConverter(AnnotatorTransformer):
    ...
    ----------
        ...
        metadataFields: dict
            The dictionary of metadata fields to be added to the chunk column.
            Add the specified data to the metadata fields of the chunk outputs in the appropriate columns.
            First element of the tuple is the column name to read the data from, and the second element is the name of the metadata field.
            The given column names must be present in the DataFrame and must be of StringType.
    ...
    def setMetadataFields(self, value: dict):
        """Sets the dictionary of metadata fields to be added to the chunk column.
        Add the specified data to the metadata fields of the chunk outputs in the appropriate columns.
        First element of the tuple is the column name to read the data from, and the second element is the name of the metadata field.
        The given column names must be present in the DataFrame and must be of StringType.
        ...
        >>>     .setMetadataFields({'label': 'entity'}) \\
        ...
        """
        self._call_java("setMetadataFields", value)
        return self
