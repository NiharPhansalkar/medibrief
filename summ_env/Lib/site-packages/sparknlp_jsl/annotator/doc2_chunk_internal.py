...
class Doc2ChunkInternal(AnnotatorTransformer, AnnotatorProperties):
    ...
    @keyword_only
    def __init__(self):
        super(Doc2ChunkInternal, self).__init__(classname="com.johnsnowlabs.annotator.Doc2ChunkInternal")
        self._setDefault(
            isArray=False
        )
    ...
    @keyword_only
    def setParams(self):
        """Sets params for this Doc2ChunkInternal.

        Returns
        -------
        Doc2ChunkInternal
            Doc2ChunkInternal with params set
        """
