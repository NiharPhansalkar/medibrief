from sparknlp_jsl.annotator import HandleExceptionParams
from sparknlp_jsl.common import *


class ContextualParserApproach(AnnotatorApproachInternal,HandleExceptionParams):
...
class ContextualParserModel(AnnotatorModelInternal,HandleExceptionParams):
    ...
    @staticmethod
    def pretrained(name="date_of_birth_parser", lang="en", remote_loc="clinical/models"):
        """Download a pre-trained ContextualParserModel.

        Parameters
        ----------
        name : str
            Name of the pre-trained model, by default "date_of_birth_parser"
        lang : str
        ...
        return InternalResourceDownloader.downloadModel(ContextualParserModel, name, lang, remote_loc,
