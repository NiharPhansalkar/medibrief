...
class BertSentenceChunkEmbeddings(BertSentenceEmbeddings, HasEngine,HandleExceptionParams):
    """
    ...
    @keyword_only
    def __init__(self, classname="com.johnsnowlabs.nlp.annotators.embeddings.BertSentenceChunkEmbeddings", java_model=None):
    ...
    def load(path: str):
        ...
        Returns:
            BertSentenceChunkEmbeddings: A pre-trained BertSentenceChunkEmbeddings.
        """
