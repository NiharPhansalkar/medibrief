...
class DeIdentification(AnnotatorApproachInternal, DeIdentificationParams, HandleExceptionParams):
    ...
    def setCombineRegexPatterns(self, value):
        ...
        If the value is 'True', both file will be used.
...
class DeIdentificationModel(AnnotatorModelInternal, DeIdentificationParams, HandleExceptionParams):
