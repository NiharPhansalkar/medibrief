...
class _PipelineTracer(ExtendedJavaWrapper):
    """Traces the pipeline model.
    """
    def __init__(self, pipeline_model):
        super(_PipelineTracer, self).__init__(
            "com.johnsnowlabs.util.tracer.PipelineTracer", pipeline_model._to_java())

class _GetParserDictDirectly(ExtendedJavaWrapper):
    """Gets the parser dictionary directly.
    """
    def __init__(self, model, language, source):
        super(_GetParserDictDirectly, self).__init__(
            "com.johnsnowlabs.util.tracer.PipelineTracer.getParserDictDirectly", model, language, source)

class _ListAvailableModels(ExtendedJavaWrapper):
    """Lists the available models.
    """
    def __init__(self, language, source):
        super(_ListAvailableModels, self).__init__(
            "com.johnsnowlabs.util.tracer.PipelineTracer.listAvailableModels", language, source)
...
class _LargeFewShotClassifierModelLoader(ExtendedJavaWrapper):
    """Loader class for the FewShotClassifierModelLoader annotator.

    This class is used to load the FewShotClassifierModelLoader annotator
    from pretrained models.
    """
    def __init__(self,  path, jspark, model_architecture, has_differentiable_head):
        super(_LargeFewShotClassifierModelLoader, self).__init__(
            "com.johnsnowlabs.nlp.annotators.classification.LargeFewShotClassifierModel.loadSavedModel",
            path,
            jspark,
            model_architecture,
            has_differentiable_head)

class _FewShotAssertionClassifierModelLoader(ExtendedJavaWrapper):
    """Loader class for the FewShotAssertionClassifierModel annotator.

    This class is used to load the FewShotAssertionClassifierModel annotator
    from pretrained models.
    """
    def __init__(self,  path, jspark, has_differentiable_head):
        super(_FewShotAssertionClassifierModelLoader, self).__init__(
            "com.johnsnowlabs.nlp.annotators.classification.FewShotAssertionClassifierModel.loadSavedModel",
            path,
            jspark,
            has_differentiable_head)
