...
class ChunkMapperApproach(A):
    """Loads a JsonDictionary that have the relations to be mapped in the ChunkMapperModel.
...
"""
    ...
    def __init__(self,
                 classname="com.johnsnowlabs.legal.chunk_classification.resolution.ChunkMapperApproach"):
...
class ChunkMapperModel(M):
    """Maps the chunks to the relations in the dictionary.
    ...
    def __init__(self, classname="com.johnsnowlabs.legal.chunk_classification.resolution.ChunkMapperModel",
                 java_model=None):
    ...
    @staticmethod
    def pretrained(name="legmapper_edgar_companyname", lang="en", remote_loc="legal/models"):
        """Download a pre-trained ChunkMapperModel.

        Parameters
        ----------
        name : str
            Name of the pre-trained model, by default "legmapper_edgar_companyname"
        lang : str
