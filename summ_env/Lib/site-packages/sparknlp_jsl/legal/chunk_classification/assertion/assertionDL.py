...
class AssertionDLApproach(A):
    ...
    validationSplit
        ...
        model on each Epoch. The value should be between 0.0 and 1.0 and by default
        it is 0.0 and off.
...
class AssertionDLModel(M):
    ...
    @staticmethod
    def pretrained(name="legassertion_time_md", lang="en", remote_loc="legal/models"):
        """Download a pre-trained AssertionDLModel.

        Parameters
        ----------
            name : str
                Name of the pre-trained model, by default "legassertion_time_md"
            lang  : str
