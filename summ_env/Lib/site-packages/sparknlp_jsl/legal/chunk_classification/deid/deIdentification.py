...
class DeIdentification(A):
    ...
    sameLengthFormattedEntities
        ...
        The supported and default formatted entities are: PHONE, FAX, ID, IDNUM, BIOID, ZIP, VIN, SSN, DLN, LICENSE, PLATE
    maskingPolicy
    ...
    @keyword_only
    def __init__(self):
        super(DeIdentification, self).__init__(classname="com.johnsnowlabs.legal.chunk_classification.deid.DeIdentification")
...
class DeIdentificationModel(M):
    ...
    These can be set with a file of
    regex patterns with setRegexPatternsDictionary, where each line is a mapping of entity to regex.
    ...
    def __init__(self, classname="com.johnsnowlabs.legal.chunk_classification.deid.DeIdentificationModel", java_model=None):
    ...
    @staticmethod
    def pretrained(name="legner_deid", lang="en", remote_loc="legal/models"):
        """Download a pre-trained DeIdentificationModel.

        Parameters
        ----------
            name : str
                Name of the pre-trained model, by default "legner_deid"
            lang : str
                Language of the pre-trained model, by default "en"
            remote_loc : str
                Remote location of the pre-trained model. If None, use the
                open-source location. Other values are "clinical/models", "finance/models", or "legal/models".
