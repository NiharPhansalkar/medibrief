...
class RelationExtractionDLModel(M):
    ...
    @staticmethod
    def pretrained(name="legre_contract_doc_parties", lang="en", remote_loc="legal/models"):
        """Download a pre-trained RelationExtractionDLModel.

        Args:
            name (str): Name of the pre-trained model, by default "legre_contract_doc_parties"
