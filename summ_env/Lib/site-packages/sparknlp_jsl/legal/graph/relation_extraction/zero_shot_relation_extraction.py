...
class ZeroShotRelationExtractionModel(M):
    """
    Extract relations between named entities using a zero-shot approach.
    ...
    +-------+----------+
    """
    # relationalCategories = Param(Params._dummy(),
    #                              "relationalCategories",
    #                              "Definitions of relational categories",
    ...
    #     from sparknlp_jsl.internal import RelationalCategories
    #     return self._set(relationalCategories=RelationalCategories(categories))

    @keyword_only
    def __init__(self, classname="com.johnsnowlabs.legal.graph.relation_extraction.ZeroShotRelationExtractionModel", java_model=None):
    ...
    @staticmethod
    def pretrained(name="legre_zero_shot", lang="en", remote_loc="legal/models"):
        """Download a pre-trained ZeroShotRelationExtractionModel.

        Parameters
        ----------
            name : str
                Name of the pre-trained model, by default "legre_zero_shot"
            lang : str
                Language of the pre-trained model, by default "en"
            remote_loc : str
                Remote location of the pre-trained model.
                If None, use the open-source location. Other values are "clinical/models", "finance/models", or "legal/models".
    ...
    def loadSavedModel(folder, spark_session):
        ...
        ZeroShotRelationExtractionModel
            The restored model
        """
        from sparknlp_jsl.internal import _LegalZeroShotRelationExtractionModelLoader
        jModel = _LegalZeroShotRelationExtractionModelLoader(folder, spark_session._jsparkSession)._java_obj
