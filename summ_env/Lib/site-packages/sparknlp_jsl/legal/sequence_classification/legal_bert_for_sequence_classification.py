...
class LegalBertForSequenceClassification(M):
    """
    LegalBertForTokenClassification  can load Bert Models with sequence classification/regression head on top
    ...
    ...     .setOutputCol("token")
    >>> tokenClassifier = LegalBertForSequenceClassification.pretrained() \\
    ...
    """
    name = "LegalBertForSequenceClassification"

    @keyword_only
    def __init__(self, classname="com.johnsnowlabs.legal.sequence_classification.LegalBertForSequenceClassification",
                 java_model=None):
        super(LegalBertForSequenceClassification, self).__init__(
            classname=classname,
    ...
    def loadSavedModel(folder, spark_session):
        ...
        LegalBertForSequenceClassification
            The restored model
        """
        from sparknlp_jsl.internal import _LegalBertForSequenceClassificationLoader
        jModel = _LegalBertForSequenceClassificationLoader(folder, spark_session._jsparkSession)._java_obj
        return LegalBertForSequenceClassification(java_model=jModel)
    ...
    @staticmethod
    def pretrained(name="legclf_reddit_advice", lang="en", remote_loc="legal/models"):
        """Download a pre-trained LegalBertForSequenceClassification.

        Args:
            name (str): Name of the pre-trained model, by default "legclf_reddit_advice"
            ...
            "finance/models", or "legal/models", by default "legal/models".

        Returns:
            LegalBertForSequenceClassification: A pre-trained LegalBertForSequenceClassification.
        """
        from sparknlp_jsl.pretrained import InternalResourceDownloader
        return InternalResourceDownloader.downloadModel(LegalBertForSequenceClassification, name, lang, remote_loc,
