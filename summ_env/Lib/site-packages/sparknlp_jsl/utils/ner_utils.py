...
def get_charts(log_file: str, threshold: float = 0.0):
    ...
    :type log_file: str
    :param threshold:  threshold, default 0.0
...
def evaluate(true_seqs: List[str], pred_seqs: List[str], verbose=True):
    ...
    :type true_seqs: List[str]
    :param pred_seqs: a list of predicted tags
    :type pred_seqs: List[str]
    :param verbose: whether to print overall performance, as well as performance per chunk type (default is True).
    :type verbose: bool
    """
