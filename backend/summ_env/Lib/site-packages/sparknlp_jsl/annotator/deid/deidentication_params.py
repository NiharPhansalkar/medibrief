...
class DeIdentificationParams:
    ...
    obfuscateDate
        When mode=='obfuscate' whether to obfuscate dates or not. This param helps in consistency to make dateFormats more v
    ...
    days
        A number of days to obfuscate the dates by displacement. If not provided a random integer between 1 and 60 will be u
    dateToYear
    ...
    isRandomDateDisplacement
        Use a random displacement days in dates entities, that random number is based on the :param:`seed`
        If true use random displacement days in dates entities, if false use the :param:`days`
        The default value is false.
    mappingsColumn
    ...
    blackList
        ...
        The default values are "IBAN","ZIP","NPI","URL","DLN","PASSPORT","EMAIL","C_CARD","DEA","SSN"
    maskingPolicy
        Select the masking policy:
            same_length_chars: Replace the obfuscated entity with a masking sequence composed of asterisks and surrounding s
            Example, Smith -> [***].
    ...
    sameLengthFormattedEntities
        ...
        The supported and default formatted entities are: PHONE, FAX, ID, IDNUM, BIOID, MEDICALRECORD, ZIP, VIN, SSN, DLN, L
    genderAwareness
    ...
    blackList = Param(Params._dummy(), "blackList",
                      "List of entities that will be ignored in the regex file. The rest will be processed.The default values are: \"SSN\",\"PASSPORT\",\"DLN\",\"NPI\",\"C_CARD\",\"IBAN\",\"DEA\"",
    ...
    def setAgeRangesByHipaa(self, value: bool):
        ...
        Args:
            value (bool): If True, age entities larger than 90 will be obfuscated as per HIPAA Privacy Rule, the others will remain unchanged.
                          If False, `ageRanges` parameter is valid.
                          Default: False.
        """
