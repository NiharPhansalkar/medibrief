...
class NerDisambiguatorModel(AnnotatorModelInternal):
    ...
    @staticmethod
    def pretrained(name="disambiguator_per", lang="en", remote_loc="clinical/models"):
        """Downloads and loads a pretrained model.

        Parameters
        ----------
        name : str, optional
            Name of the pretrained model, by default "disambiguator_per"
        lang : str, optional
        ...
        return ResourceDownloader.downloadModel(NerDisambiguatorModel, name, lang, remote_loc,
