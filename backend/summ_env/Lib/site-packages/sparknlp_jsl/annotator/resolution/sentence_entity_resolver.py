...
class SentenceEntityResolverApproach(AnnotatorApproachInternal, SentenceResolverParams, HasEngine):
    ...
    - ``sentence_embeddings``: Sentence embeddings from, e.g., the BertSentenceEmbeddings
    annotator.
    ...
    - ground_truth: Ground truth of the conceptId present in the knowledge base.
    Can be used as auxiliary column.
    ...
    def setLabelCol(self, name:bool):
    ...
    def setNormalizedCol(self, name:bool):
