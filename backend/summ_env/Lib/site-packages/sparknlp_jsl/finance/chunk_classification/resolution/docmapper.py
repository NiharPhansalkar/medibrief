...
class DocMapperApproach(AnnotatorApproachInternal, CommonChunkMapperParams, ChunkMapperFuzzyMatchingParams):
    ...
    def __init__(self, classname="com.johnsnowlabs.finance.chunk_classification.resolution.DocMapperApproach"):
...
class DocMapperModel(AnnotatorModelInternal, CommonChunkMapperParams, ChunkMapperFuzzyMatchingParams):
    ...
    def __init__(self, classname="com.johnsnowlabs.finance.chunk_classification.resolution.DocMapperModel", java_model=None):
    ...
    def pretrained(name="", lang="en", remote_loc="finance/models"):
        ...
        Returns:
            DocMapperModel: A pre-trained DocMapperModel.
        """
