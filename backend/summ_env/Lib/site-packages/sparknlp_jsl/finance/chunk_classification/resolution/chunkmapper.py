...
"""
    ...
    @staticmethod
    def pretrained(name="finmapper_edgar_companyname", lang="en", remote_loc="finance/models"):
        """Download a pre-trained ChunkMapperModel.

        Args:
            name (str): Name of the pre-trained model, by default "finmapper_edgar_companyname"
