...
#  limitations under the License."""Contains classes for Doc2Chunk."""
...
class FinanceDocumentHashCoder(A):
    ...
    @keyword_only
    def __init__(self):
        super(A, self).__init__(classname="com.johnsnowlabs.finance.chunk_classification.deid.FinanceDocumentHashCoder")
        self._setDefault(
            rangeDays=365
        )
