...
class FinanceBertForTokenClassification(M):
    ...
    def pretrained(name="finner_responsibility_reports", lang="en", remote_loc="finance/models"):
        ...
        Args:
            name (str): Name of the pre-trained model, by default "finner_responsibility_reports"
        ...
        Returns:
            FinanceBertForTokenClassification: A pre-trained FinanceBertForTokenClassification.
        """
