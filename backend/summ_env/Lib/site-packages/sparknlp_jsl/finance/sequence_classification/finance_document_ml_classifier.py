...
class FinanceDocumentMLClassifierApproach(A):
    ...
    def _create_model(self, java_model:str):
        ...
        """
        return FinanceDocumentMLClassifierModel(java_model=java_model)

    @keyword_only
    def __init__(self):
        super(A, self).__init__(
            classname="com.johnsnowlabs.finance.sequence_classification.FinanceDocumentMLClassifierApproach")
        self._setDefault(
            labelCol="selector",
            maxIter=10,
            tol=1e-6,
...
class FinanceDocumentMLClassifierModel(M):
    ...
    def __init__(self, classname="com.johnsnowlabs.finance.sequence_classification.FinanceClassifierDLModel",
                 java_model=None):
        super(FinanceDocumentMLClassifierModel, self).__init__(
            classname=classname,
    ...
    def pretrained(name, lang="en", remote_loc=None):
        """Download a pre-trained FinanceDocumentMLClassifierModel.
        ...
        Returns:
            FinanceDocumentMLClassifierModel: A pre-trained FinanceDocumentMLClassifierModel.
        """
        from sparknlp_jsl.pretrained import InternalResourceDownloader
        return InternalResourceDownloader.downloadModel(FinanceDocumentMLClassifierModel, name, lang, remote_loc,
