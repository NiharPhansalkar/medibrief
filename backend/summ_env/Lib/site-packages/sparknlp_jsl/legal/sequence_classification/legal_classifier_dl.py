...
class LegalClassifierDLApproach(A):
    ...
    def _create_model(self, java_model:str):
        ...
        """
        return LegalClassifierDLModel(java_model=java_model)

    @keyword_only
    def __init__(self):
        super(A, self).__init__(
            classname="com.johnsnowlabs.legal.sequence_classification.LegalClassifierDLApproach")
        self._setDefault(
            maxEpochs=30,
            lr=float(0.005),
            batchSize=64,
...
class LegalClassifierDLModel(M):
    ...
    def __init__(self, classname="com.johnsnowlabs.legal.sequence_classification.LegalClassifierDLModel",
                 java_model=None):
        super(LegalClassifierDLModel, self).__init__(
            classname=classname,
            java_model=java_model
        )
    @staticmethod
    def pretrained(name="legclf_argument_mining", lang="en", remote_loc="legal/models"):
        ...
        Returns:
            LegalClassifierDLModel: A pre-trained LegalClassifierDLModel.
        """
        from sparknlp_jsl.pretrained import InternalResourceDownloader
        return InternalResourceDownloader.downloadModel(LegalClassifierDLModel, name, lang, remote_loc,
