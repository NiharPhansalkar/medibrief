...
class SentenceEntityResolverApproach(A):
    ...
    overrideExistingCodes
        Whether to override the existing codes with new data while continue the
        training from a pretrained model. Default value is false(keep all the codes).
    ...
    @keyword_only
    def __init__(self):
        AnnotatorApproach.__init__(self,
...
class SentenceEntityResolverModel(M):
    ...
    @staticmethod
    def pretrained(name="legel_edgar_company_name", lang="en", remote_loc="legal/models"):
        """Download a pre-trained SentenceEntityResolverModel.

        Args:
            name (str): Name of the pre-trained model, by default "legel_edgar_company_name"
