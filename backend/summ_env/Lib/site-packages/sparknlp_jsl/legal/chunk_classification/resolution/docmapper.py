...
class DocMapperApproach(AnnotatorApproachInternal, CommonChunkMapperParams, ChunkMapperFuzzyMatchingParams):
    ...
    def __init__(self, classname="com.johnsnowlabs.legal.chunk_classification.resolution.DocMapperApproach"):
...
class DocMapperModel(AnnotatorModelInternal, CommonChunkMapperParams, ChunkMapperFuzzyMatchingParams):
    ...
    def __init__(self, classname="com.johnsnowlabs.legal.chunk_classification.resolution.DocMapperModel", java_model=None):
