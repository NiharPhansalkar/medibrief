...
class LegalNerApproach(A):
    ...
    def _create_model(self, java_model:str):
        ...
        """
        return LegalNerModel(java_model=java_model)

    @keyword_only
    def __init__(self):
        AnnotatorApproachInternal.__init__(
            self, classname="com.johnsnowlabs.legal.token_classification.ner.LegalNerApproach")
...
class _LegalNerModelLoader(ExtendedJavaWrapper):
    def __init__(self, ner_model_path, path, jspark):
        super(_LegalNerModelLoader, self).__init__(
            "com.johnsnowlabs.legal.token_classification.ner.LegalNerModel.loadSavedModel",
            ner_model_path, path, jspark)


class LegalNerModel(M):
    ...
    def __init__(self, classname="com.johnsnowlabs.legal.token_classification.ner.LegalNerModel",
                 java_model=None):
        super(LegalNerModel, self).__init__(
            classname=classname,
    ...
    #     return ResourceDownloader.downloadModel(LegalNerModel, name, lang, remote_loc)

    @staticmethod
    def loadSavedModel(ner_model_path, folder, spark_session):
        jModel = _LegalNerModelLoader(ner_model_path, folder, spark_session._jsparkSession)._java_obj
        return LegalNerModel(java_model=jModel)

    @staticmethod
    def pretrained(name="legner_contract_doc_parties_lg", lang="en", remote_loc="legal/models"):
        """Downloads and loads a pretrained model.

        Parameters
        ----------
        name : str, optional
            Name of the pretrained model, by default "legner_contract_doc_parties_lg"
        lang : str, optional
        ...
        return InternalResourceDownloader.downloadModel(LegalNerModel, name, lang, remote_loc,
