...
class LegalBertForTokenClassification(M):
    ...
    def loadSavedModel(folder, spark_session):
        ...
        LegalBertForTokenClassification
            The restored model
        """
        from sparknlp_jsl.internal import _LegalBertForTokenClassificationLoader
        jModel = _LegalBertForTokenClassificationLoader(folder, spark_session._jsparkSession)._java_obj
    ...
    def loadSavedModelOpenSource(bertForTokenClassifierPath, tfModelPath, spark_session):
        ...
        LegalBertForTokenClassification
            The restored model
        """
        from sparknlp_jsl.internal import _LegalBertForTokenClassificationLoaderOpensource
        jModel = _LegalBertForTokenClassificationLoaderOpensource(bertForTokenClassifierPath, tfModelPath,
                                                             spark_session._jsparkSession)._java_obj
        return LegalBertForTokenClassification(java_model=jModel)

    @staticmethod
    def pretrained(name="legner_bert_grants", lang="en", remote_loc="legal/models"):
        """Download a pre-trained LegalBertForTokenClassification.

        Args:
            name (str): Name of the pre-trained model, by default "legner_bert_grants"
        ...
        Returns:
            LegalBertForTokenClassification: A pre-trained LegalBertForTokenClassification.
        """
