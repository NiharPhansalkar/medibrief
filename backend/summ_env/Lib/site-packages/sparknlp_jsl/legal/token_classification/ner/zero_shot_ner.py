...
class ZeroShotNerModel(A):
    ...
    @keyword_only
    def __init__(self, classname="com.johnsnowlabs.legal.token_classification.ner.ZeroShotNerModel", java_model=None):
    ...
    @staticmethod
    def pretrained(name="legner_roberta_zeroshot", lang="en", remote_loc="legal/models"):
        """Download a pre-trained ZeroShotNerModel.

        Args:
            name (str): Name of the pre-trained model, by default "legner_roberta_zeroshot"
    ...
    def load(path: str):
        ...
        Returns:
            ZeroShotNerModel: A pre-trained ZeroShotNerModel.
        """
        from sparknlp_jsl.internal import _RobertaQAToLegalZeroShotNerLoader
        jModel = _RobertaQAToLegalZeroShotNerLoader(path)._java_obj
